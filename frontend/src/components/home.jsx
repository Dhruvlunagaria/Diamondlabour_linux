...
//               <a href="/login" className="hover:text-sky-400 transition-colors duration-300">Login</a>
//               <a href="/manager" className="hover:text-sky-400 transition-colors duration-300">Manager</a>
//               <a href="/worker" className="hover:text-sky-400 transition-colors duration-300">Worker</a>
//               {/* <a href="/table/:tableNo" className="hover:text-sky-400 transition-colors duration-300">Table</a> */}
//               <a href="/addworker" className="hover:text-sky-400 transition-colors duration-300">Add Worker</a>
//               <a href="/register" className="hover:text-sky-400 transition-colors duration-300">Register</a>
//               <a href="#testimonials" className="hover:text-sky-400 transition-colors duration-300">Testimonials</a>
